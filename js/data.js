...
const PRACTICE_POOL_5 = [
  ...
  "FEAST","TOWER","VAULT","MOODY","TONKS","FLEUR","BLAST",
  "FUNGI","PRANK","ARGUS","POPPY","FILCH","CRANE","STORM",
  "EMBER","REALM","CURSE","GLEAM","RELIC","MANOR","ABBEY","GROVE",
  "SHARD","CRYPT","POUCH","HOLLY","BLAZE","CHILL","SHADE","PRISM",
  "SWAMP","MARSH","BROOD","GLOOM","SHEEN","FLASK","MORPH",
  "ABYSS","ASHEN","CHANT","DREAD","DWELL","FABLE",
  "GRAIL","HEXED","QUEST","ROGUE","TRACE",
  "WISPY","CEDAR","HARPY","PETAL",
  "RISKY","SPRIG","WIZEN","FETID","EERIE","STONY",
  "MISTY","DUSTY","ASHES","TOADS","FETCH","COVEN",
  "BROIL","ANVIL","PLUME","CHAOS","RAVEN","IVORY","AMBER","Accio", "Albus", "Argus", "Avery", "Barty", "Binns", "Black", "Blood", "Broom", "Charm", "Cloak", "Draco", "Dobby", "Errol", "Felix", "Filch", "Fleur", "Flint", "Goyle", "Grawp", "Harry", "Hooch", "House", "James", "Kappa", "Lupin", "Magic", "Molly", "Moody", "Mungo", "Nundu", "Pansy", "Percy", "Pixie", "Remus", "Ronan", "Rowle", "Runes", "Snape", "Spell", "Susan", "Sword", "Sybil", "Teddy", "Tonks", "Troll", "Veela", "Wands", "Winky", "Witch"
].filter(w => w.length === 5);
...
const PRACTICE_POOL_6 = [
  ...
  "FAWKES","HEDWIG","GEORGE","FENRIR","CROUCH","BANTER",
  "HOLLOW","HALLOW","GHOSTS","SPOOKY","PONDER","FIENDS",
  "ELVISH","FRENZY","HORROR","JESTER","KNIGHT","LAGOON","MYSTIC",
  "PILLAR","RAFTER","SHRINE","TAVERN","CHASER","BEATER",
  "AMULET","BANISH","CINDER","DIVINE","KELPIE","LEGEND",
  "MARVEL","WARDED","BEASTS","MARBLE","HERALD",
  "ORNATE","GILDED","WYVERN","ALASTOR","CEDRIC","FAWKES","GEORGE","GOLBET","GODRIC","SICKLE","SEEKER","NAGINI","PEEVES","SNITCH","RIDDLE","ERISED",
  "HEXING","SPIRIT","MUSING","THRALL","HARROW","MIRROR"
].filter(w => w.length === 6);
...
const PRACTICE_POOL_8 = [
  ...
  "HORNTAIL","WORMTAIL","ANIMAGUS","MANDRAKE","ROSMERTA","UNICORNS","MCLAGGEN","UMBRIDGE","CONFUNDO","PORTRAIT",
  // Spells & magic terms
  "DESCENDO","FANTASIA","WITCHERY","DARKARTS",
  "MYSTICAL","CHARMING","DEFENDER","SPECTRES","POTIONER",
  "GALLEONS",
  // Wizarding world atmosphere
  "MOONBEAM","STARDUST","CRYSTALS","FEARSOME","GLIMMERY","SHUNPIKE","MINISTRY","WIZARDRY","LOVEGOOD","PORTKEY","NIFFLERS","BOGGARTS","DELACOUR","THESTRAL",
  "TREELINE","LANTERNS","DARKENED","GOBSTONE","FIREBOLT","DEATHDAY","HOGSHEAD","PENSIEVE","MANDRAKE","BUCKBEAK","SCABBERS","CENTAURS","MOONCALF","GRIPHOOK",
  "GHOSTLIT"
].filter(w => w.length === 8);
