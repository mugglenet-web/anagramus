...
const PRACTICE_POOL_6 = [
  ...
  "MARVEL","NYMPHS","WARDED","BEASTS","CURSED","MARBLE","DONJON",
  "CHAISE","WICKER","TAWDRY","OSSIFY","MAGICK","ORNATE","GILDED",
  "WYVERN","SPECTER","MIRAGE","HEXING","SPIRIT","MYSTIC","HERALD"
].filter(w => w.length === 6);
...
const PRACTICE_POOL_8 = [
  ...
  "SORCERER","PARCHMENT","SLYTHERIN","CHAMBERS","PRISONER","PROPHECY",
  "MYSTICAL","CHARMING","DEMENTOR","THESTRAL","WANDCRAFT","WANDMAKER",
  "VOLDEMORT","BELLATRIX","GRIPHOOK","ALOHOMORA","SPARKBOLT","SILENCIO",
  "DESCENDO","FANTASIA","BLOODLINE","BASILISK","SPELLBOOK","RAVENCLAW",
  "DUMBLEDOR","FIERYFIST","WITCHERY","MOONBEAM","STARDUST","CRYSTALS",
  "MIMBULUS","NIFFLERS","RUNESPOOR","ACROMANT","DARKARTS","HERBOLOGY",
  "OLLIVANDE","ENCHANTED","DRAGONFLY","GHOSTLIKE","BROOMSTIK","HUFFLEPUF",
  "GRIFFINDO","QUIDDITCH","TRANSFIG","FORBIDDEN","ASTRONOMY","PROPHECY",
  "SPELLCAST","ROWANWOOD","THORNWOOD","CLOUDLIKE","INKQUILL","PRISONER",
  "FEARSOME","REVEALER","DEFENDER","SPECTERS","GLIMMERY","STORMFED",
